      ...
      <div className="registerWrapper">
        <div className="registerLeft">
          ...
          <div className="registerLeftText">
            ...
            <p className="registerDesc">{t("disc-logo-text")}</p>
          </div>
        </div>
        <div className="registerRight">
          <form className="registerBox" onSubmit={handleClick}>
            ...
            <input
              type="password"
              placeholder={t("enter-repeat-pass")}
              required
              ref={passwordAgain}
              className="registerInput"
            />
            ...
            <button className="registerLoginButton" onClick={buttonClick}>
              {t("log-into-account-text")}
            </button>
          </form>
        </div>
      </div>
